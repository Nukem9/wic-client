...
#include "MMG_Protocols.h" // Bring in Massgate protocol version numbers etc
...
{
public:
	MMG_ClanName() = default;

	MMG_ClanName(u32 aClanId, MMG_ClanFullNameString& aClanName) : clanId(aClanId), clanName(aClanName)
	{
	}
