...
public:
	...
	virtual void RemapVSOutputs(uint *aVSOutputRemaps, MR_VertexShaderSetupData *aVSSetupData);

	virtual int GetMaxNumBonesPerBoneGroup(MR_Mesh *aMesh);

	virtual void GetXYZ(MR_Mesh *aMesh, uint aVertIndex, MC_Vector3<float> *aResultXYZ);
	...
	uint			myVertexShaderId;	// this+0x18
};
